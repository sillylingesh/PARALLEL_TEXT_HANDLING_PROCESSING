...
ALERT_WORDS = {"error","fail","failure","danger","critical","warning"}##----->##Unique Feature
...
def main():
    ...
    print("Processing",len(sentences),"Chunks")
     
     #Parallel Process-multiple core

    cpu_count = multiprocessing.cpu_count()

    workers = cpu_count * 2 # Dynamic Thread Allocation 
